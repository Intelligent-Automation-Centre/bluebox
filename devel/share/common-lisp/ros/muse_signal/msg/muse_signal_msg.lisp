...
(cl:defclass <muse_signal_msg> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass muse_signal_msg (<muse_signal_msg>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <muse_signal_msg>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'muse_signal_msg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name muse_signal-msg:<muse_signal_msg> is deprecated: use muse_signal-msg:muse_signal_msg instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <muse_signal_msg>))
...
(cl:defmethod name-val ((m <muse_signal_msg>))
...
(cl:defmethod signal-val ((m <muse_signal_msg>))
  ...
  (signal m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <muse_signal_msg>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <muse_signal_msg>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<muse_signal_msg>)))
  "Returns string type for a message object of type '<muse_signal_msg>"
  "muse_signal/muse_signal_msg")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'muse_signal_msg)))
  "Returns string type for a message object of type 'muse_signal_msg"
  "muse_signal/muse_signal_msg")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<muse_signal_msg>)))
  "Returns md5sum for a message object of type '<muse_signal_msg>"
  "b1f20b4a32a60f17a676c278f6e49d2b")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'muse_signal_msg)))
  "Returns md5sum for a message object of type 'muse_signal_msg"
  "b1f20b4a32a60f17a676c278f6e49d2b")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<muse_signal_msg>)))
  "Returns full string definition for message of type '<muse_signal_msg>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'muse_signal_msg)))
  "Returns full string definition for message of type 'muse_signal_msg"
  (cl:format cl:nil "# This message hold data that describes the temperature  of the Muse headband signal~%#~%# this messages conatines an arry based on the defined \"name\" sensors ()~%#~%#~%#~%#~%~%Header header~%string[] name~%float64[] signal~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <muse_signal_msg>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <muse_signal_msg>))
  "Converts a ROS message object to a list"
  (cl:list 'muse_signal_msg
